...
export default function HomeSearch() {
  ...
  return (
    <>
    <form onSubmit={handleSubmit}className='flex w-full m5-5 mx-auto max-w-[90%] border border-gray-200 px-5 py-3 rounded-full
    ...
    justify-center sm:flex-row mt-8">
        ...
        <button disable={randomSearchLoading}onClick={randomSearch} className='btn flex items-center justify-center disabled:opacity-80'>
            {randomSearchLoading ?(
                <img src="loading.svg" alt="loading.." className='h-6
                text-center'/>) :(
                    "sam's search"
                )
            }</button>
